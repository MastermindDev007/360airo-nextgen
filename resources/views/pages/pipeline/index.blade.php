<div>
    <x-slot:header>
        ...
        <div class="flex flex-wrap gap-2 mt-4 sm:mt-0">
            <x-ui.button variant="secondary" size="sm" class="flex-1 sm:flex-none justify-center">
            ...
            <x-ui.button variant="primary" class="flex-1 sm:flex-none justify-center"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>Add Deal</x-ui.button>
        </div>
    </x-slot:header>
    ...
    {{-- Kanban Board --}}
    <div class="flex gap-4 overflow-x-auto hide-scrollbar pb-4 -mx-4 px-4 lg:mx-0 lg:px-0">
        @php
        $stages = [
